...
public class Carpenter extends AppCompatActivity implements feedadapter.OnItemClickListener {
...
//zawedt 3la elfeedadapter array tany 3l4an yb2a feh el details
                            mfeedAdapter = new feedadapter(Carpenter.this, recycleview);
                            mRecyclerView.setAdapter(mfeedAdapter);
                            mfeedAdapter.setOnItemClickListener(Carpenter.this);
